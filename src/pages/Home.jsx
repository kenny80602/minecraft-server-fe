      ...
      <main className="flex-grow flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-lg mt-12 bg-[#161b22] border border-[#30363d] rounded-xl shadow-2xl backdrop-blur-sm p-8 lg:p-10 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <button className="w-full bg-[#06C755] hover:bg-[#05b34c] text-white font-medium py-2.5 px-4 rounded-lg shadow-sm shadow-green-900/20 flex items-center justify-center gap-3 transition-colors group border border-transparent" type="button" onClick={handleLineLogin}>
